...
#SBATCH --job-name=alphafold_full_dibs_poly_g_96_cpu
...
OUTPUT_DIR=~/scratch/fred862/data/bioinfo/output/dibs_af_full/poly_g_96
INPUT_DIR=~/scratch/fred862/data/bioinfo/input/seq_to_pred/dibs/poly_g_96
