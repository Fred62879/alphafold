...
#SBATCH --job-name=alphafold_full_ds2_poly_g_20_gpu
...
OOM_FN=~/scratch/fred862/data/bioinfo/input/seq_to_pred/ds2/pdb_gpu_oom.npy
DONE_FN=~/scratch/fred862/data/bioinfo/input/seq_to_pred/ds2/pdb_gpu_done.npy
