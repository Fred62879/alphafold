...
OOM_FN=~/scratch/fred862/data/bioinfo/input/seq_to_pred/ds3/pdb_gpu_oom.npy
DONE_FN=~/scratch/fred862/data/bioinfo/input/seq_to_pred/ds3/pdb_gpu_done.npy
CPU_EXCLUDE_FN=~/scratch/fred862/data/bioinfo/input/seq_to_pred/ds3/pdb_cpu_exclude.npy
GPU_EXCLUDE_FN=~/scratch/fred862/data/bioinfo/input/seq_to_pred/ds3/pdb_gpu_exclude.npy
