...
#SBATCH --job-name=alphafold_full_ds4_poly_g_20_gpu
...
OUTPUT_DIR=~/scratch/fred862/data/bioinfo/output/ds4_af_full/poly_g_20
INPUT_DIR=~/scratch/fred862/data/bioinfo/input/seq_to_pred/ds4/poly_g_20
FASTA_FN=~/scratch/fred862/data/bioinfo/input/seq_to_pred/ds4/pdb_ids.npy
OOM_FN=~/scratch/fred862/data/bioinfo/input/seq_to_pred/ds4/pdb_gpu_oom.npy
DONE_FN=~/scratch/fred862/data/bioinfo/input/seq_to_pred/ds4/pdb_gpu_done.npy
CPU_EXCLUDE_FN=~/scratch/fred862/data/bioinfo/input/seq_to_pred/ds4/pdb_cpu_exclude.npy
GPU_EXCLUDE_FN=~/scratch/fred862/data/bioinfo/input/seq_to_pred/ds4/pdb_gpu_exclude.npy
